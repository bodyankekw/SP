    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (iteration <= M)
            {
                ...
                v[1] = Math.Round((vector[0]*matrix[0,1]+vector[1]* matrix[1,1]+vector[2]*matrix[2,1]+vector[3]*matrix[3,1]),2);
                v[2] = Math.Round((vector[0]*matrix[0,2]+vector[1]*matrix[1,2]+vector[2]*matrix[2,2]+vector[3]*matrix[3,2]),2);
                v[3] = Math.Round((vector[0]*matrix[0,3]+vector[1]*matrix[1,3]+vector[2]*matrix[2,3]+vector[3]*matrix[3,3]),2);
                vector[0] = v[0];
                vector[1] = v[1];
                vector[2] = v[2];
                vector[3] = v[3];
